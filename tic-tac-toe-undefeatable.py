...
class Game(Tk):
    ...
    def check_win(self):
        for i in range(3):
            if (self.board[i][0] == self.board[i][1]) and (self.board[i][1] == self.board[i][2]) and self.board[i][
                1] != ' ':
                return (1, self.board[i][0])
            if (self.board[0][i] == self.board[1][i]) and (self.board[1][i] == self.board[2][i]) and self.board[2][
                i] != ' ':
                return (1, self.board[1][i])
        if (self.board[0][0] == self.board[1][1]) and (self.board[1][1] == self.board[2][2]) and self.board[1][
            1] != ' ':
